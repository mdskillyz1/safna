...
export const products: Product[] = [
  {
    ...
    ingredients: "Red chilli, tomato, onion, garlic, vinegar, lemon, spices. Final recipe to be confirmed.",
    allergens: "No declared allergens in draft recipe. Final allergen statement required before live sales.",
    storage: "Store in a cool dry place. Refrigerate after opening and use within the stated period.",
    shelfLife: "Draft shelf life: 6 months unopened. Final best-before rules to be confirmed.",
  ...
  },
  {
    ...
    heatLevel: "Medium",
    dietary: "Vegan friendly",
    ingredients: "Green herbs, chilli, citrus, garlic, vinegar, seasoning. Final recipe to be confirmed.",
    allergens: "Final allergen statement required before live sales.",
    storage: "Store chilled once opened. Keep sealed when not in use.",
    shelfLife: "Draft shelf life: 4 months unopened. Final best-before rules to be confirmed.",
  ...
  },
  {
    ...
    ingredients: "Tomato, pepper, onion, vinegar, spices. Final recipe to be confirmed.",
    allergens: "Final allergen statement required before live sales.",
  ...
  },
  {
    ...
    ingredients: "Salt, herbs, spices, garlic, onion, paprika. Final blend to be confirmed.",
    allergens: "Packed in an environment statement required before launch.",
    storage: "Keep sealed in a cool dry cupboard away from direct sunlight.",
    shelfLife: "Draft shelf life: 12 months. Final best-before rules to be confirmed.",
  ...
  },
  {
    ...
    ingredients: "Roasted spice blend, chilli, ginger, garlic, smoked paprika. Final recipe to be confirmed.",
    allergens: "Peanut and nut handling status must be confirmed before launch.",
  ...
  },
  {
    ...
    longDescription:
      "A starter bundle designed for first-time customers and gifting. The final bundle contents can be managed from the admin dashboard.",
    badge: "Best seller",
    colour: "#a7f3c2",
    size: "3 products",
    stock: 15,
    ...
    allergens: "Allergens vary by product. Final bundle allergen statement required.",
    storage: "Store according to each product label.",
    shelfLife: "Best-before date follows the shortest-dated product in the bundle.",
    extraWording: "Bundle contents may vary while the range is being finalised.",
    image: "/safna-logo.jpg",
    status: "Published",
    visibility: "Public",
    isBundle: true,
  ...
  },
  {
    ...
    extraWording: "Gift packaging design to be confirmed.",
    image: "/safna-logo.jpg",
    status: "Published",
    visibility: "Public",
    isBundle: true,
  ...
  },
  {
    ...
    heatLevel: "Medium",
    dietary: "Recipe TBC",
    ingredients: "Tomato, pepper, onion, oil, spices. Final recipe to be confirmed.",
    allergens: "Final allergen statement required before live sales.",
    storage: "Storage and refrigeration rules to be confirmed after packaging is finalised.",
    shelfLife: "Best-before and shelf-life details to be confirmed.",
